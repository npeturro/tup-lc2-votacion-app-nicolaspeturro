    ...
    if (localStorage.getItem('INFORMES') !== null) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log(data);
                console.log(datos);
                console.log(datos[12][0].nombreAgrupacion);
                /*let contador = 1;
                datos[12].forEach((info) => {
                  console.log(info[12][contador].nombreAgrupacion);
                  contador ++
                });*/
                ...
                datosInforme = {
                  ...
                  agrupacionNombre: datos[12][0].nombreAgrupacion,
                  agrupacionVotos: datos[12][0].votos,
                  agrupacionPorcentaje: datos[12][0].votosPorcentaje,
...
function mostrarInforme(){
  ...
  <table>
                ...
                <tbody>
                    <td id="provincia-informe">
                      ${provincias[datosInforme.distritoID]}
                    </td>
                    <td class="tabla-elecciones" id="">
                        <p class="texto-elecciones-chico" id="titulo-informe"><b>Elecciones ${datosInforme.anio} | ${datosInforme.tipoEleccionNombre}</b></p>
                        <p class="texto-path-chico" id="subtitulo-informe">${datosInforme.anio} > ${datosInforme.tipoEleccionNombre} > ${datosInforme.cargoNombre}
                         > ${datosInforme.distritoNombre}</p>

                    </td>
                    <td class="tabla-iconos">
                        <div class="escrutadas">
                            ...
                            <p id="escrutadas-informe">Mesas Escrutadas ${datosInforme.mesasEscrutadas}</p>
                        </div>
                        <div class="electores">
                            ...
                            <p id="electores-informe">Electores<br>${datosInforme.electores}</p>
                        </div>
                    ...
                    <td>
                        <p>${datosInforme.agrupacionNombre}<br>${datosInforme.agrupacionPorcentaje}%<br>${datosInforme.agrupacionVotos} votos</p>
